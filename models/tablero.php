...
class Tablero
{
    ...
    public function saveActivity($tabla)
    {
        ...
        $guardar = $this->db->prepare("INSERT INTO $tabla VALUES(null, :titulo, :fecha, :des, :color, :registro)");
        ...
        $guardar->bindParam(":registro", $registro, PDO::PARAM_STR);
