...
class DirectorController
{
    ...
    {
        if (!isset($_GET['subject']) || !isset($_GET['name']) || !isset($_GET['degree']) || !isset($_GET['namede'])) {
            Utils::Error404();
        } elseif (empty(Utils::decryption($_GET['subject'])) || empty(Utils::decryption($_GET['degree'])) || empty($_GET['name']) || empty($_GET['namede'])) {
            Utils::Error404();
        } else {
