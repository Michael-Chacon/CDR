		...
		<article class="col-xs-12 col-sm-12 col-md-4 col-xl-4">
			<div class="card text-center shadow option fondo-elemento">
				<div class="card-body contenido-card">
					...
					<a class="stretched-link" href="<?=base_url?>Configuracion/vista_aula">
					</a>
				</div>
			</div>
		</article>
		...
		<article class="col-xs-12 col-sm-12 col-md-4 col-xl-4">
			<div class="card text-center shadow option">
				<div class="card-body contenido-card">
					...
					<a class="stretched-link" href="<?=base_url?>Configuracion/vista_directores">
					</a>
				</div>
			</div>
		</article>
		<article class="col-xs-12 col-sm-12 col-md-4 col-xl-4">
			<div class="card text-center shadow option">
				<div class="card-body contenido-card">
					...
					<a class="stretched-link" href="<?=base_url?>Configuracion/vista_havilitar_boletin">
					</a>
				</div>
			</div>
		</article>
		<article class="col-xs-12 col-sm-12 col-md-4 col-xl-4">
			<div class="card text-center shadow option">
				<div class="card-body contenido-card">
					...
					<a class="stretched-link" href="<?=base_url?>Iconos/vista">
					</a>
				</div>
			</div>
		</article>
