                                        ...
                                        <div class="dropdown">
                                            ...
                                            <li>
                                                <a class="dropdown-item" href="<?=base_url?>Materias/matricularMaterias&student=<?=Utils::encryption($estudiante_id)?>&degree=<?=Utils::encryption($grado)?>&fathers=<?=$padres?>">
                                                    <i class="bi bi-plus-circle-dotted"></i>  Matricular materias
                                                </a>
                                            </li>
                                            <li>
                                                <hr class="dropdown-divider"/>
                                             ...
                                             <li>
                                                <a class="dropdown-item" href="<?=base_url?>Materias/listadoMateriasStudent&student=<?=Utils::encryption($estudiante_id)?>&degree=<?=Utils::encryption($grado)?>&fathers=<?=$padres?>">
                                                    <i class="bi bi-trash"></i>  Eliminar materias
                                                </a>
                                            </li>
                                            <li>
                                                <hr class="dropdown-divider"/>
                                             ...
                                             <li>
                                                <a class="dropdown-item" href="<?=base_url?>Estudiante/eliminarEstudiante&student=<?=Utils::encryption($estudiante_id)?>&degree=<?=Utils::encryption($grado)?>&fathers=<?=Utils::encryption($padres)?>&name=<?=Utils::encryption($estudiante->nombre_e .' '.$estudiante->apellidos_e)?>&document=<?=Utils::encryption($estudiante->numero_e)?>" onclick="return confirmar()">
                ...
                <div class="card-body">
                    ...
                    <div class="row text-center">
                        <div class="col-md-6 mt-3 mb-3">
                            <span class="item_info">Fecha de nacimiento:</span> <span class="valor_item"><?=Utils::fechaShortCarbon($estudiante->fecha_nacimiento_e)?></span>
                        </div>
                        <div class="col-md-6 mt-3 mb-3">
                        ...
                        <div class="col-md-6 mt-3 mb-3">
                            <span class="item_info">Fecha de expedición:</span> <span class="valor_item"><?=Utils::fechaShortCarbon($estudiante->fecha_expedicion_e)?></span>
                        </div>
                        <div class="col-md-6 mt-3 mb-3">
                ...
                <div class="card-body">
                    ...
                    <div class="row text-center">
                        ...
                        <?php if (!empty($estudiante->nombre_m)): ?>
                            ...
                            <div class="col-md-6 mt-3">
                                <span class="item_info">Fecha de nacimiento: </span>    <span class="valor_item"><?=Utils::fechaShortCarbon($estudiante->fecha_nacimiento_m)?></span>
                            </div>
                            <div class="col-md-6 mt-3">
                            ...
                            <div class="col-md-6 mt-3">
                                <span class="item_info">Fecha expedición: </span>   <span class="valor_item"><?=Utils::fechaShortCarbon($estudiante->fecha_expedicion_m)?></span>
                            </div>
                            <div class="col-md-6 mt-3">
                        ...
                        <?php if (!empty($estudiante->nombre_p)): ?>
                            ...
                            <div class="col-md-6 mt-3">
                                <span class="item_info">Fecha de nacimiento: </span>    <span class="valor_item"><?=Utils::fechaShortCarbon($estudiante->fecha_nacimiento_p)?></span>
                            </div>
                            <div class="col-md-6 mt-3">
                            ...
                            <div class="col-md-6 mt-3">
                                <span class="item_info">Fecha expedición: </span>   <span class="valor_item"><?=Utils::fechaShortCarbon($estudiante->fecha_expedicion_p)?></span>
                            </div>
                            <div class="col-md-6 mt-3">
