         ...
         <article class="col-xs-1 col-sm-1 col-md-1 col-lg-1 config icono-menu text-center">
            <acticle class="btn-group dropstart">
                ...
                <ul class="dropdown-menu">
                    ...
                    <li><hr class="dropdown-divider"></li>
                    <li><a class="dropdown-item" href="<?=base_url?>/Grado/eliminarGrado&id_grado=<?=$actual->id?>&name=<?=$actual->nombre_g?>&dir=<?=$direc->fetchObject()->id?>" onclick="return confirmar()"><i class="bi bi-trash"></i>  Eliminar grado</a></li>
                </ul>
            </acticle>
        </article>
    <?php endif;?>
